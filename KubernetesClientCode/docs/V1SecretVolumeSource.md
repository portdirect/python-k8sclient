...
------------ | ------------- | ------------- | -------------
**secret_name** | **str** | Name of the secret in the pod&#39;s namespace to use. More info: http://releases.k8s.io/release-1.4/docs/user-guide/volumes.md#secrets | [optional] 
